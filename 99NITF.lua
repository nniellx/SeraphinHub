...
Window:EditOpenButton({
    ...
    StrokeThickness = 2,
    Color = ColorSequence.new(Color3.fromRGB(27, 42, 53), Color3.fromRGB(107, 50, 124)),
    Draggable = true,
})
...
Tabs.Kill = Window:Tab({
    Title = "Kill",
    Icon = "sword",
    Desc = "Seraphin"
})
 Tabs.Item = Window:Tab({
    Title = "Bring Item",
...
Tabs.Home:Button({
    Title = "Discord",
    Desc = "Copy Link Discord Invite ",
    Locked = false,
    Callback = function()
        setclipboard("https://discord.gg/KakVrmWT")
    end
})


Tabs.Kill:Section({ Title = "Aura", Icon = "swords" })

Tabs.Kill:Slider({
    Title = "Aura Radius",
    Value = { Min = 50, Max = 300, Default = 50 },
    Callback = function(value)
        auraRadius = math.clamp(value, 10, 300)
    end
})
...
Tabs.Item:Section({ Title = "Bring Medicine Item", Icon = "briefcase-medical" })
...
Tabs.Item:Section({ Title = "Bring Food Item", Icon = "apple" })
...
Tabs.Item:Section({ Title = "Equipment", Icon = "sword" })
...
Tabs.Item:Section({ Title = "Fuel", Icon = "sun" })
...
Tabs.Item:Section({ Title = "Bring Junk Item", Icon = "moon" })
...
Tabs.Player:Section({ Title = "Player", Icon = "drone" })
...
Tabs.Player:Section({ Title = "Fullbrigt and more", Icon = "eye" })
...
Tabs.Player:Section({ Title = "Instant", Icon = "settings" })
...
Tabs.esp:Section({ Title = "Esp Items And Esp Entity", Icon = "package" })
...
Tabs.tp:Section({ Title = "Children", Icon = "moon" })
...
Tabs.Auto:Section({ Title = "Auto Upgrade", Icon = "flame" })

Tabs.Auto:Dropdown({
    Title = "Chosse The Items",
    Desc = "Auto Upgrade",
